...
public class DefaultTeam {
    ...
    public Line calculDiametre(ArrayList<Point> points) {
        return tme3naif(points);
    }
    private Line tme3naif(ArrayList<Point> points) {
        if (points.size()<2) {
            return null;
        }
    ...
    public Line calculDiametreOptimise(ArrayList<Point> points) {
        return tme3exercice2(points);
    }
    private Line tme3exercice2(ArrayList<Point> points) {
        if (points.size()<2) {
            return null;
        }
    ...
    private ArrayList<Line> calculPairesAntipodales(ArrayList<Point> points) {
        ArrayList<Point> p = tme2exercice5(points); // p est l'enveloppe convexe de points
        int n = p.size();
    ...
    public ArrayList<Point> enveloppeConvexe(ArrayList<Point> points){
        //return tme2exercice1(points);
        //return tme2exercice2(points);
        //return tme2exercice1(tme2exercice2(points));
        //return tme2exercice1(tme2exercice3(points));
        //return tme2exercice4(points);
        //return tme2exercice5(points);
        return tme2exercice6(points);
    }
    private ArrayList<Point> tme2exercice1(ArrayList<Point> points){
    ...
    private ArrayList<Point> tme2exercice2(ArrayList<Point> points){
        if (points.size()<4) return points;
    ...
    private ArrayList<Point> tme2exercice3(ArrayList<Point> points){
        if (points.size()<4) return points;
    ...
    private ArrayList<Point> tme2exercice4(ArrayList<Point> points){
        if (points.size()<4) return points;
    ...
    private ArrayList<Point> tme2exercice5(ArrayList<Point> points){
        if (points.size()<4) return points;
    ...
    private ArrayList<Point> tme2exercice6(ArrayList<Point> points){
        if (points.size()<4) return points;
